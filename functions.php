...
function devwp_scripts() {
	...
	wp_enqueue_style( 'devwp-fantawesome', get_template_directory_uri() . '/fonts/font-awesome/css/fontawesome.min.css' );

	wp_enqueue_style( 'devwp-style', get_stylesheet_uri() );

	wp_enqueue_script( 'devwp-bootstrap', get_template_directory_uri() . '/src/js/bootstrap.min.js', array('jquery'), '20151215', true );

	wp_enqueue_script( 'devwp-navigation', get_template_directory_uri() . '/src/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'devwp-link-focus', get_template_directory_uri() . '/src/js/skip-link-focus-fix.js', array(), '20151215', true );
	wp_enqueue_script( 'devwp-tether', get_template_directory_uri() . '/src/js/tether.min.js', array(), '20151215', true );
